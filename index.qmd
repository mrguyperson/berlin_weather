...
::: {.valuebox icon="thermometer-half" color="secondary"}
**Latest day vs. historical median:**

`r if (nrow(latest_day_summary) == 0) "—" else glue("{sprintf('%+.1f', latest_day_summary$anomaly)} °C")`
